...
This is the second of several labs that are part of the **CSH Campaign Assets 2018: ICS File Transfer workshop**. This workshop will demonstrate how to read an opaque file from a "/" directory and write the file to an "/upload" directory in a scheduled orchestrated integration. 

In the first lab (100), focused on provisioning the Oracle Integration Cloud environment and have it ready for running this workshop. In this lab you will assume the persona of the Java developer, who will be tasked with creating a microservices that will allow for retrieval and filtering of twitter data.
